...
async sendButtonMessage(jid, contnt, ftrr, button1, button2) {
const buttons = [
{buttonId: '1', buttonText: {displayText: button1}, type: 1},
{buttonId: '2', buttonText: {displayText: button2}, type: 1}
]
const buttonMessage = {
contentText: contnt,
footerText: ftrr,
